...
export const mockSoundcloudLinks = [
  ...
  { title: 'Oscar Mulero - Source Artists Live Streaming - 11.04.2020', url: 'https://soundcloud.com/oscarmulero/oscar-mulero-source-artists-live-streaming-11042020' },
  { title: 'Nada Records / Stanislav Tolkachev @ Gare Porto', url: 'https://soundcloud.com/nadarecords/nada-records-stanislav-tolkachev-gare-porto' },
  { title: 'Vladimir Dubyshkin live at Reaktor 2019', url: 'https://soundcloud.com/reaktorevents/vladimir-dubyshkin-live-at-reaktor-2019' },
  { title: 'Fugal at Tresor, Berlin (New Faces | May 3, 2017)', url: 'https://soundcloud.com/fugal/fugal-at-tresor-berlin-new-faces-2017' },
  { title: "Invite's Choice Podcast 588 - Roseen", url: 'https://soundcloud.com/invite-1/invites-choice-podcast-588-roseen' },
];
